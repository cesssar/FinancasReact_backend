...
@app.get("/cadastros/conta", response_model=list[ContaResponse], tags=["Conta"],  summary="Lista as contas cadastradas")
...
@app.post("/cadastros/conta", response_model=ContaResponse, status_code=status.HTTP_201_CREATED, tags=["Conta"],  summary="Cadastra uma nova conta")
...
@app.delete("/cadastros/conta/{id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Conta"],  summary="Deleta uma conta desde que zerada e não esteja em uso")
...
@app.put("/cadastros/conta/{id}/{valor}", tags=["Conta"],  summary="Debita ou credita um valor a uma conta")
...
@app.get("/cadastros/cartaocredito", response_model=list[CartaoCreditoResponse], tags=["Cartão Crédito"],  summary="Lista os cartões de crédito cadastrados")
...
@app.post("/cadastros/cartaocredito", response_model=CartaoCreditoResponse, status_code=status.HTTP_201_CREATED, tags=["Cartão Crédito"],  summary="Cadastra um novo cartão de crédito")
...
@app.delete("/cadastros/cartaocredito/{id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Cartão Crédito"],  summary="Deleta um cartão de crédito zerado e sem lançamentos")
...
@app.put("/cadastros/cartaocredito/{id}/{valor}", tags=["Cartão Crédito"],  summary="Lança uma compra/despesa em um cartão de crédito")
...
@app.put("/cadastros/cartaocredito/pagarfatura/{id}/{valor}", tags=["Cartão Crédito"],  summary="Informa pagamento da fatura recompondo limite")
...
@app.get("/cadastros/categoria", response_model=list[CategoriaResponse], tags=["Categoria"],  summary="Lista as categorias cadastradas")
...
@app.post("/cadastros/categoria", response_model=CategoriaResponse, status_code=status.HTTP_201_CREATED, tags=["Categoria"],  summary="Cadastra uma nova categoria")
...
@app.delete("/cadastros/categoria/{id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Categoria"],  summary="Deleta uma categoria sem uso")
...
@app.get("/cadastros/lancamento/{mes}/{ano}", tags=["Lançamento"],  summary="Lista os lançamentos cadastrados")
...
@app.post("/cadastros/lancamento", status_code=status.HTTP_201_CREATED, tags=["Lançamento"],  summary="Cadatra um novo lançamento")
...
@app.delete("/cadastros/lancamento/{id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Lançamento"],  summary="Deleta uma categoria sem uso")
